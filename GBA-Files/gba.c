...
int collision(int col, int row, int width, int height, int colO, int rowO, int widthO, int heightO) {
    return (row + height >= rowO) && (row <= rowO + heightO) && (col + width >= colO) && (col <= colO + widthO);
}
